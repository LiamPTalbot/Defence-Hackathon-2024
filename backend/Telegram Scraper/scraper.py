...
def scrape_messages(group_name, limit=20, output_file=None):
    if output_file is None:
        output_file = os.path.join(os.path.expanduser('~'), 'Desktop/Hackathon', 'messages.txt')
...
group_name = 'Ukrenergo'
# @ukrainelive123, @pravdaGerashchenko_en, @mykolaivskaODA, @ButusovPlus, @informnapalm, @uniannet, @Tsaplienko
